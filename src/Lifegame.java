...
public class Lifegame extends JFrame {
    ...
    public void paint_line(Graphics g,final int row,final int col){
    ...
    public void paint_map(Graphics g,final int cell[][],final int row,final int col){
    	int temp=(int)(170/row);
    	for(int i=0;i<row;i++) {
    		for(int j=0;j<col;j++) {
    			if(cell[i][j]==1) {
    ...
    public void clear_map(Graphics g,final int row,final int col){
    	int temp=(int)(170/row);
